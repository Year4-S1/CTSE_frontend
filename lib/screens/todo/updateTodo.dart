...
class _UpdateTodoState extends State<UpdateTodo> {
  ...
  getData() async {
    ...
    setState(() {
      todoId = widget.todoDetails['_id'];
      titleController.text = widget.todoDetails['reminderTitle'];
      remarksController.text = widget.todoDetails['reminderMessage'];
      ...
      body: WillPopScope(
        onWillPop: () async {
          return !await saveDiscardPopup(
              context, "Todo", updateTodo, discardNote);
        },
        child: loaded
            ? GestureDetector(
                onTap: () {
